...
export default function Home() {
  return (
    <div id="home">
      ...
      <h2>A News Site For The Next Generation</h2>
      <p>
        BLOG is here to deliver you all the latest news - concise &
        unbiased!
      </p>

      <p>
        BLOG aims to provide you with the latest news in a concise and
